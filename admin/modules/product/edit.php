...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
     ...
     if(postInput('category_id')=='')
    {
     ...
     if(postInput('price')=='')
    {
        $error['price']="Gía tiền không được để trống";
    }
    if(postInput('infoPro')=='')
    {
        $error['infoPro']="Bạn vui lòng nhập thông tin sản phẩm";
    }
    if(postInput('number')=='')
    {
        $error['number']="Số lượng sản phẩm không được để trống";
    }
    if(empty($error))
    {
        ...
        <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class=" form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="form-group">
                            <textarea class="form-control" name="infoPro" row="4"
                                value="<?php echo $Editproduct['infoPro'] ?>"></textarea>
                            <?php
